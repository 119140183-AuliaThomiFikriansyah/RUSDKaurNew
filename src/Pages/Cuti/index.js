...
const Cuti = () => {
  ...
  const [keperluanCuti, setKeperluanCuti] = useState('');
      ...
      <ScrollView>
        <View style={styles.Footer}>
          <View style={styles.ViewFooter}>
            <DropKeperluanCuti
              onInputChange={value => {
                setKeperluanCuti(value);
              }}
            />
          </View>
          <View style={styles.ViewFooter}>
            <TanggalCuti onInputChange={handleTanggalChange} />
          </View>
          <View style={styles.ViewFooter}>
            <UploadFoto
              onInputChange={value => {
